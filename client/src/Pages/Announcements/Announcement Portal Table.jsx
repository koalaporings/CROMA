             ...
             <div className="tables-container">
                ...
                <table className="table1">
                    <tr>
                        ...
                        <td className='description'>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercita...”</td>
                    </tr>
                    <tr>
                        <td className='title-date'><p className='title'>Announcement Title</p><p className='date'>10/01/2022 , 12:43pm</p></td>
                        <td className='description'>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercita...”</td>
