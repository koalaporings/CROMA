...
const AnnouncementSignatoryPage = ({children}) => {
    ...
    return(
        <div>
            <NavBar/>
            <div className="header-announcements-signatory">
                <Header/>
            </div>
            ...
            <Container>
                ...
                <div className="student-announcement-table-container">
                    <AnnouncementTableComponent
                        type = 'signatory_announcement_table'
...
export default AnnouncementSignatoryPage;